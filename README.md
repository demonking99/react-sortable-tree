...
[![Build Status](https://travis-ci.org/demonking99/react-sortable-tree.svg?branch=master)](https://travis-ci.org/demonking99/react-sortable-tree)
[![Coverage Status](https://coveralls.io/repos/github/demonking99/react-sortable-tree/badge.svg?branch=master)](https://coveralls.io/github/demonking99/react-sortable-tree?branch=master)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)

> A React component for Drag-and-drop sortable representation of hierarchical data. Checkout the [Storybook](https://demonking99.github.io/react-sortable-tree/) for a demonstration of some basic and advanced features.
...
Check out the helper functions exported from [`tree-data-utils.js`](https://github.com/demonking99/react-sortable-tree/blob/master/src/utils/tree-data-utils.js).
